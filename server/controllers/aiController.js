...
await sql`INSERT INTO creations (user_id,prompt,content,type,publish) VALUES (${userId},${prompt}, ${secure_url}, ${content}, 'image', ${publish ?? false })`;
...
await sql`INSERT INTO creations (user_id,prompt,content,type,publish) VALUES (${userId}, 'Review the uploaded resume,  ${content}, 'resume-review')`;
