...
import { Cone, Hash, Sparkles } from 'lucide-react'
...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try{
      ...
      console.log(prompt);
      const { data } = await axios.post('http://localhost:3000/api/ai/generate-blog-title',{prompt},{headers: {Authorization : `Bearer ${await getToken()}`}})
